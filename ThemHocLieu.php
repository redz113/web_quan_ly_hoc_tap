		...
		if (isset($_POST['saveHL'])) {
			...
			if (isset($kq)&&!empty($kq)) {
				...
				if ($extension=="pdf") {
					...
					$sql = "INSERT INTO tb_hoc_lieu(ten_hoc_lieu, ten_file_hoc_lieu, id_khoa_hoc) VALUES('$tenHL', '$tenFileHL', $idKH)";
                    mysqli_query($conn, $sql);
					echo "<div class='check'>Cập nhật học liệu mới thành công!</div>";
				}
			}
		}
	?>
